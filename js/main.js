$(() => {
    ...
    $('#toGame03').on('click', () => {
        ...
        $('#luckynumber', window.parent.document).text('幸運數字 : 24 121')
    })
    ...
    $('#toGame04').on('click', () => {
        ...
        $('#luckynumber', window.parent.document).text('幸運數字 : 24 121 16')
    })
    ...
    $('#toGame05').on('click', () => {
        ...
        $('#luckynumber', window.parent.document).text('幸運數字 : 24 121 16 4')
